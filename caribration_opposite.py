...
#python .\caribration_opposite.py ./Outputs/csv/data_foot_movie12_opposite.csv 

def calculate_homography(court_coords, target_coords):
    # Convert lists of tuples todeavtivate
    #  numpy arrays
...
target_coords = [(-5.485, 11.885), (5.485, 11.885), (5.485, 23.77), (-5.485, 23.77)]
...
# Remove frames where the player's y-coordinate is less than 11
